        ...
        >
          <a
            ...
            className={cn(
              ...
              "h-11 px-6 text-sm active:bg-[color-mix(in_oklab,var(--primary)_88%,black)]",
            )}
          >
            Book a 20-min demo
          </a>
          <a
            ...
            className={cn(
              ...
              "h-11 px-6 text-sm border-border bg-transparent text-foreground active:bg-secondary",
            )}
          >
            Sign in
          </a>
