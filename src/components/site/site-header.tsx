      ...
      >
        ...
        >
          <a
            ...
            className={cn(
              buttonVariants({ variant: "ghost", size: "sm" }),
              "h-9 px-3 text-sm font-medium text-foreground hover:bg-secondary",
            )}
          >
            Sign in
          </a>
          <a
            ...
            className={cn(
              ...
              "h-9 px-4 text-sm hover:bg-[color-mix(in_oklab,var(--primary)_90%,black)] focus-visible:ring-3 focus-visible:ring-ring/50",
            )}
          >
            Book a demo
          </a>
