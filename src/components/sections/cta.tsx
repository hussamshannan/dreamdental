        ...
        >
          <a
            ...
            className={cn(
              ...
              "h-10 px-6 text-sm hover:bg-[color-mix(in_oklab,var(--primary)_90%,black)] focus-visible:ring-3 focus-visible:ring-ring/50",
            )}
          >
            Book a 20-min demo
          </a>
          <a
            ...
            className={cn(
              ...
              "h-10 px-6 text-sm border-border bg-transparent text-foreground hover:bg-secondary focus-visible:ring-3 focus-visible:ring-ring/50",
            )}
          >
            Talk to sales
          </a>
